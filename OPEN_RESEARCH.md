...
This agenda records five initial tracks for a research draft. Completing a track does not itself create a standard.
...
Completion does not itself create a standard.
